...
const videoApi = {
  ...
  // Update video
  updateVideo: async (videoId: string, data: { title?: string; description?: string; isPublic?: boolean; categoryIds?: string[]; tags?: string[]; thumbnailUrl?: string; price?: number }): Promise<VideoResponse> => {
