              ...
              <>
                ...
                <div className='relative my-4'>
                  ...
                  <div className='relative flex justify-center text-sm'>
                    <span className='px-2 bg-primary text-gray-500 dark:text-gray-400'>Hoặc</span>
                  </div>
                </div>
                ...
                <button
                  type='button'
                  onClick={handleGoogleLogin}
                  className='w-full py-3 px-4 border-2 border-gray-300 dark:border-gray-600 rounded-lg font-medium hover:bg-secondary transition-colors flex items-center justify-center gap-3'
                >
                  <svg className='w-5 h-5' viewBox='0 0 24 24'>
                    <path fill='#4285F4' d='M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.26 1.37-1.04 2.53-2.21 3.31v2.77h3.57c2.08-1.92 3.28-4.74 3.28-8.09z'/>
                    <path fill='#34A853' d='M12 23c2.97 0 5.46-.98 7.28-2.66l-3.57-2.77c-.98.66-2.23 1.06-3.71 1.06-2.86 0-5.29-1.93-6.16-4.53H2.18v2.84C3.99 20.53 7.7 23 12 23z'/>
                  ...
                  <span className='text-foreground'>Đăng nhập với Google</span>
                </button>
