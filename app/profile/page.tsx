                ...
                {selectedMenu === 'password' && (
                  <div className="max-w-md space-y-4">
                    <div>
                      ...
                      <input type="password" name="passwordOld" value={passwordData.passwordOld} onChange={handleInputChange}
                    ...
                    <div>
                      ...
                      <input type="password" name="passwordNew" value={passwordData.passwordNew} onChange={handleInputChange}
                        className={`w-full px-4 py-3 rounded-lg border ${isDark ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300'}`} />
                    </div>
                    <div>
                      <label className={`block text-sm font-medium mb-2 ${isDark ? 'text-gray-300' : 'text-gray-700'}`}>Xác nhận mật khẩu mới</label>
                      <input type="password" name="confirmPassword" value={passwordData.confirmPassword} onChange={handleInputChange}
                        className={`w-full px-4 py-3 rounded-lg border ${isDark ? 'bg-gray-700 border-gray-600 text-white' : 'bg-white border-gray-300'}`} />
                    </div>
                    {error && <div className="p-3 rounded-lg bg-red-100 border border-red-300 text-red-700 text-sm">{error}</div>}
                    {success && <div className="p-3 rounded-lg bg-green-100 border border-green-300 text-green-700 text-sm">{success}</div>}
